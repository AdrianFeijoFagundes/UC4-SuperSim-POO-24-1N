export class Produto {
    ...
    public getId(): number { return this.idProduto; } 
    ...
    public getCustoCompra(): number { return this.custoCompra; }
    public setCustoCompra(custoCompra: number): void { this.custoCompra = custoCompra; }
